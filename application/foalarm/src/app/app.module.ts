...
import { FilterPipe, FilterDatePipe, AlertPipe, FilterUserPipe, SafePipe, FilterAuthUser } from './pipes/alert.pipe';
...
@NgModule({
  declarations: [
    ...
    CameraListComponent,
    CameraViewComponent,
    FilterPipe, FilterDatePipe, AlertPipe, FilterUserPipe, SafePipe, FilterAuthUser, DataGraphComponent, CalcComponent,
