...
@NgModule({
  declarations: [
    ...
    ReportLinkComponent, DataComponent, AlarmLinkComponent, HorseLinkComponent, AlarmIdListComponent, AlarmEditModalComponent, AlarmEditFormComponent, HorseEditFormComponent, ModalComponent,
  ],
  imports: [
    BrowserModule,
    ChartsModule,
